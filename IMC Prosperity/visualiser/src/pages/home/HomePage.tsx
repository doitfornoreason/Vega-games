...
import { LoadMultipleFiles } from './LoadMultipleFiles.tsx';
    ...
    <Container>
      <Stack>
        <HomeCard title="Welcome!">
          {/* prettier-ignore */}
          <Text>
            IMC Prosperity 4 Visualiser is a visualizer for <Anchor href="https://prosperity.imc.com/" target="_blank" rel="noreferrer">IMC Prosperity 3</Anchor> algorithms.
        ...
        <HomeCard title="Prerequisites">
          <Text>
            IMC Prosperity 4 Visualiser assumes your algorithm logs in a certain format. Algorithms that use a different
